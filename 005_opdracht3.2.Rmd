...
I had/have to fill 32 hours learning something new that will be useful for my internship next year and possibly my job.
...
<br>
```{r OTU1 relative, message=FALSE, warning=FALSE, eval=FALSE}
# Abundance berekenen
...
You could approach the continuous variable as a correlation. In general only strong correlations, with r being greater than 0.5 or smaller than -0.5, should be reported. Here we'll use Kendall-Tau because it doesn't assume linearity or normality.