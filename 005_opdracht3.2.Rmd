...
#        mode = "markers", 
#        color = meta$AgeGroup, 
#        colors = c("blue", "green", "red")) # Deze uitgezet omdat 3D plots niet werken
```
<br>
...
#       mode = "markers", 
#       color=meta$AgeGroup, 
#       colors=c("pink", "purple", "blue")) # Ook deze uitgezet omdat 3D plots niet werken
```
<br>
<br>
...
<br>
In the tutorial, we looked at the abundance of OTU00001 in the three age groups. I will look at the abundance of OTU00003. <br>
In the tutorial, we saw that most of the P-values of OTU00003 in KW.results.signif were lower than 0.05, so there was a significant difference.
<br>
```{r abund otu00003, message=FALSE, warning=FALSE}
abund = OTU.clean/rowSums(OTU.clean)*100
boxplot(abund$Otu00003 ~ meta$AgeGroup,
        ylab = "Relative abundance (%)",
        main = "OTU3")
```
<br>
Looking at the boxplot and the P-values, we can say that OTU00003 is significantly more abundant in 2 week old calves than in 8 week old calves or 1 year old heifers.
