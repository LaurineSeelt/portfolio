...
```
<br>
I created a graph to show the COVID-19 cases per day for a specific month, and I also created a graph for the amount of COVID-19 related deaths per day for a specific month. In this markdown, I did this for Austria.
<br>
