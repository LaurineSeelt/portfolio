...
```
<br>
First I took a look at the data and read it in in RStudio.
<br>
...
<br>
CompConcentration is een character, which is kind of weird. This column contains the concentrations of the compounds that were used, so you'd expect this column to be double.
<br>
...
<br>
To make the X-axis more redeable, I changed the column compConcentration to numeric and I plotted the Log10 of the concentration. I also used geom_jitter to create some distance between the datapoints. This makes the graph a bit clearer.
<br>
