...
# Reading two different studies and recreating some of the code

This was the second assignment for our portfolio. We had to look up two different articles, answer some questions about it and recreate some of the code from one of the articles.
...
The code was very readable, and I recreated one of the graphs from the study.
